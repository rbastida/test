    ...
    <div id="content">
        ...
        <form id="form_requisicao" class="form-horizontal" action="{$form_action}" method="POST">
                ...
                <div class="col-md-5">
                    <select id="cd_secretaria" name="cd_secretaria" class="select form-control" required="required">
                        ...
                        {foreach $secretarias as $sec} 
                            ...
                            {if $cd_secretaria == $sec.cd_secretaria}
                                <option value="{$sec.cd_secretaria}" selected>{$sec.nm_secretaria|upper}</option>
                            {else}
                    ...
                    <div class="col-md-5">
                        <select id="id_local_estagio" name="id_local_estagio" class="select form-control" required="required">
                            ...
                            {foreach $local as $l} 
                                ...
                                {if $id_local_estagio == $l.id_local_estagio}
                                <option value="{$l.id_local_estagio}" selected>{$l.nm_local_estagio|upper} - {$l.nu_andar}º andar</option>
                                {else}
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <select id="cd_tp_contrato" name="cd_tp_contrato" class="select form-control" required="required">
                        ...
                        {foreach $tipos_contrato as $t}
                            
                            {if $cd_tipo_contrato == $t.cd_tipo_contrato}
                                <option value="{$t.cd_tipo_contrato}" selected>{$t.nm_tipo_contrato}</option>
                            {else}    
                                <option value="{$t.cd_tipo_contrato}">{$t.nm_tipo_contrato}</option>
                            {/if}
                ...
                <div class="col-md-5">
                    <select id="cd_curso" name="cd_curso" class="select form-control" required="required">
                        ...
                        {foreach $curso as $cur} 
                            ...
                            {if $cd_curso == $cur.cd_ident_crg}
                            <option value="{$cur.cd_ident_crg}" selected>{$cur.cd_ident_crg} - {$cur.nm_extenso_crg|upper}</option>
                            {else}
            ...
            <div class="col-md-offset-4 col-md-8">
                ...
                <input type="hidden" type="text" class="btn btn-primary" name="qt_registros_local" id="qt_registros_local" value="{$qt_registros_local}">
                <input type="hidden" type="text" class="btn btn-primary" name="id_protocolo" id="id_protocolo" value="{$id_protocolo}">
                <input type="hidden" type="text" class="btn btn-primary" name="id_requisicao" id="id_requisicao" value="{$id_requisicao}">
                <input type="hidden" type="text" class="btn btn-primary" name="id_supervisor" id="id_supervisor" value="{$id_supervisor}">
            </div>
        </form>
    </div>
